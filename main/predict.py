...
def predict(predict_data, gene_dim, model_file, hidden_folder, batch_size, result_file, cell_features):
	...
	for i, (inputdata, labels) in enumerate(test_loader):
		...
		for i in range(len(cuda_features[0, 0, :])):
			...
			with open(result_file + '_feature_grad_' + str(i) + '.txt', 'w') as f:
...
# parser.add_argument('-results', help='Dataset to be predicted', type=str,default ='../sample/test_data.txt')
parser.add_argument('-results', help='Dataset to be predicted', type=str,default ='../test_data.txt')
parser.add_argument('-batchsize', help='Batchsize', type=int, default=10000)
parser.add_argument('-gene2id', help='Gene to ID mapping file', type=str, default='../sample/gene2ind.txt')
parser.add_argument('-cell2id', help='Cell to ID mapping file', type=str, default='../sample/cell2ind.txt')
# parser.add_argument('-load', help='Model file', type=str,default='../pretrained_models/palbociclib/model_Palbociclib_1.pt')
parser.add_argument('-load', help='Model file', type=str,default='../sample/model/model_final.pt')
parser.add_argument('-hidden', help='Hidden output folder', type=str, default='../hidden/')
parser.add_argument('-result', help='Result file prefix', type=str, default='../result/results')
parser.add_argument('-cuda', help='Specify GPU', type=int, default=0)
parser.add_argument('-mutations', help = 'Mutation information for cell lines', type = str,default ='../sample/cell2mutation.txt')
parser.add_argument('-cn_deletions', help = 'Copy number deletions for cell lines', type = str,default ='../sample/cell2cndeletion.txt')
parser.add_argument('-cn_amplifications', help = 'Copy number amplifications for cell lines', type = str,default ='../sample/cell2cnamplification.txt')
parser.add_argument('-zscore_method', help='zscore method (zscore/robustz)', type=str)
parser.add_argument('-std', help='Standardization File', type=str, default='../sample/std.txt')
