...
def main():
	...
	parser.add_argument('-onto', help = 'Ontology file used to guide the neural network', type = str,default = '../sample/ontology.txt')
	parser.add_argument('-train', help = 'Training dataset', type = str,default = '../train_data.txt')
	# parser.add_argument('-train', help = 'Training dataset', type = str,default = '../sample/training_data.txt')
	...
	parser.add_argument('-modeldir', help = 'Folder for trained models', type = str, default = '../sample/model')
